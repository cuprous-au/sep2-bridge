...
pub struct Metrics {
    ...
    pub sep2_dcap_failures: Counter,
}
...
pub fn initialise() -> Registry {
    let metrics = Metrics {
        ...
        sep2_dcap_failures: Counter::default(),
    };
    ...
    registry.register(
        "sep2_dcap_failures",
        "The number of times a connection to the SEP2 dcap endpoint failed",
        metrics.sep2_dcap_failures.clone(),
    );
