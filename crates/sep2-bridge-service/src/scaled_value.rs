...
///
/// This struct is very similar to rust_decimal::Decimal, however it allows for
/// preserving the type of the value, which is important when doing translation
/// between SEP2 <-> SunSpec with small u16s and i16s.
